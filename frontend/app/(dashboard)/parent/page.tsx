        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-gray-500 text-sm font-medium">Children Enrolled</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="flex flex-wrap gap-4">
                    <a href="/parent/child-progress" className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                        View Child Progress
                    </a>
