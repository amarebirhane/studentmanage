...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: t('features.student.desc'),
      color: "indigo"
    },
    {
      icon: Users,
      title: t('features.parent.title'),
      desc: t('features.parent.desc'),
      color: "purple"
    },
    {
      icon: BookOpen,
      title: t('features.curriculum.title'),
      desc: t('features.curriculum.desc'),
      color: "pink"
    },
    {
      icon: Clock,
      title: t('features.attendance.title'),
      desc: t('features.attendance.desc'),
      color: "orange"
    },
    {
      icon: ShieldCheck,
      title: t('features.financial.title'),
      desc: t('features.financial.desc'),
      color: "green"
    }
  ];
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-left duration-1000">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <Link href="/register" className="w-full sm:w-auto">
                <Button size="lg" className="h-14 px-8 text-lg font-bold w-full rounded-2xl shadow-xl shadow-primary/20 hover:scale-[1.02] transition-all">
                  {t('startFreeTrial')} <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
            ...
            <div className="flex items-center gap-6 pt-4 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-500" /> {t('noCreditCard')}
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="h-5 w-5 text-green-500" /> {t('setupInMinutes')}
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-in fade-in slide-in-from-right duration-1000">
            ...
            <div className="absolute -bottom-6 -left-6 glass-card p-4 rounded-2xl shadow-2xl animate-bounce-slow">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs text-muted-foreground">{t('features.student.title')}</div>
            ...
            <div className="absolute top-10 -right-6 glass-card p-4 rounded-2xl shadow-2xl animate-float">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs text-muted-foreground">{t('features.attendance.title')}</div>
      ...
      <section id="features" className="py-24 px-6 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-20">
            <h2 className="text-primary font-bold tracking-widest uppercase text-sm">{t('moduleSubtitle')}</h2>
            <h3 className="text-4xl lg:text-5xl font-bold tracking-tight">{t('moduleTitle')}</h3>
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto relative">
          ...
          <div className="relative glass-card bg-primary/5 border-primary/20 p-12 lg:p-20 rounded-[3rem] text-center space-y-8 overflow-hidden">
            ...
            <h2 className="text-4xl lg:text-6xl font-bold tracking-tight">{t('ctaTitle')}</h2>
      ...
      <footer className="py-12 px-6 border-t border-white/5 bg-black/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-6 text-sm">
            <Link href="/privacy" className="text-muted-foreground hover:text-foreground">{t('privacy')}</Link>
            <Link href="/terms" className="text-muted-foreground hover:text-foreground">{t('terms')}</Link>
          </div>
        </div>
      </footer>
    </div>
